...
QT_MOC_LITERAL(1, 13, 15), // "ViewTextUpdated"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 3), // "str"
QT_MOC_LITERAL(4, 34, 20), // "UpdateCursorPosition"
QT_MOC_LITERAL(5, 55, 8) // "position"

    },
    "SequenceView\0ViewTextUpdated\0\0str\0"
    "UpdateCursorPosition\0position"
};
...
void SequenceView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ViewTextUpdated((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->UpdateCursorPosition((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SequenceView::ViewTextUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SequenceView::ViewTextUpdated(QString _t1)
{
