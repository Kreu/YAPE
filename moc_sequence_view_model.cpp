...
#include "include/sequence_view_model.h"
...
QT_MOC_LITERAL(1, 18, 21), // "CursorPositionChanged"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 8), // "position"
QT_MOC_LITERAL(4, 50, 14), // "CallComplement"
QT_MOC_LITERAL(5, 65, 21), // "IsTextSelectedUpdated"
QT_MOC_LITERAL(6, 87, 1), // "b"
QT_MOC_LITERAL(7, 89, 15), // "ViewTextUpdated"
QT_MOC_LITERAL(8, 105, 3) // "str"

    },
    "SequenceViewModel\0CursorPositionChanged\0"
    "\0position\0CallComplement\0IsTextSelectedUpdated\0"
    "b\0ViewTextUpdated\0str"
};
...
void SequenceViewModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CursorPositionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->CallComplement(); break;
        case 2: _t->IsTextSelectedUpdated((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->ViewTextUpdated((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SequenceViewModel::CursorPositionChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SequenceViewModel::CursorPositionChanged(int _t1)
{
